...
// flag to updatePump serial; set in interrupt callback
volatile uint8_t tick_tock = 1;

// INT0 interrupt callback; updatePump tick_tock flag
...
void setup () {
  ...
  // turn on 1Hz clock out, used as INT0 for serial updatePump every second
